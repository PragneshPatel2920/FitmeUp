         ...
         <div className="row">
             <div className="col-lg-10 offset-lg-1">
                 <div className="contact_info_container d-flex flex-lg-row flex-column justify-content-between align-items-between">
                     <div className="contact_info_item d-flex flex-row align-items-center justify-content-start bg-light container">
                         <div className="contact_info_image">
                         <img src="https://img.icons8.com/office/24/000000/iphone.png" alt="" /></div>
                         <div className="contact_info_content">
                             <div className="contact_info_title">Phone</div>
                             <div className="contact_info_text">+91 98249 84674 <br /> +91 63555 65881 </div>
                         </div>
                     </div> 
                     <div className="contact_info_item d-flex flex-row align-items-center justify-content-start bg-light container">
                         ...
                         <div className="contact_info_content">
                             ...
                             <div className="contact_info_text">pagupatel29@gmail.com <br />patelrahul205200@gmail.com</div>
                         </div>
                     </div> 
                     <div className="contact_info_item d-flex flex-row align-items-center justify-content-start bg-light container">
                         ...
                         <div className="contact_info_content">
                             ...
                             <div className="contact_info_text">Ahmedabad, <br />Gujarat 380061</div>
                         </div>
                     </div>
                 </div>
             </div>
            ...
            <div className="contact_form bg-dark p-2">
